...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary mb-2 float-right" id="servicesAdd">Add New</button>
            ...
            <!-- Modal start -->
            <div id="servicesModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
