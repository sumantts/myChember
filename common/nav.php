		...
		<div class="navbar-wrapper">
			<div class="navbar-content scroll-div" id="nav_bar">
				...
				<ul class="nav pcoded-inner-navbar " >
					...
					<li class="nav-item pcoded-hasmenu <?php if($p == 'profile' || $p == 'multi_center_setup' || $p == 'group_master' || $p == 'configure_services' || $p == 'service_based_pricing'){ ?> active pcoded-trigger <?php } ?>">
					    ...
					    <ul class="pcoded-submenu">
					        ...
					        <li <?php if($p == 'group_master'){ ?> class="active" <?php } ?> ><a href="?p=group_master&gr=settings" >Group master </a></li>
					...
					<li class="nav-item pcoded-hasmenu <?php if($p == 'online_appointment' || $p == 'new_patient_registration' || $p == 'patient_past_history' || $p == 'investigation' || $p == 'upload_documents' || $p == 'visit_summary' || $p == 'search_patient' || $p == 'reminder_sms' || $p == 'reply_queries_chat'){ ?> active pcoded-trigger <?php } ?>">
						...
						<ul class="pcoded-submenu">
							...
							<li <?php if($p == 'visit_summary'){ ?> class="active" <?php } ?>><a href="?p=visit_summary&gr=p_mgt">Visit Summary</a></li>
